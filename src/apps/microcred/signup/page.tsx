...
export default function SignupPage() {
  ...
  async function onResend() {
    ...
    try {
      ...
      const origin = typeof window !== 'undefined' ? window.location.origin : process.env.NEXT_PUBLIC_SITE_URL || 'https://bizen.mx'
    ...
    <main style={{ background: bgColor, minHeight: "100dvh", padding: 24, display: "grid" as const, placeItems: "center" }}>
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 480, flex: "1 1 480px" }}>
          <Card>
            <div style={{ display: "grid" as const, gap: 8, marginBottom: 16, textAlign: "center" }}>
              <h1 style={{ margin: 0, fontSize: 28, color: "#111" }}>Crear cuenta</h1>
        ...
        <div style={{ flex: "0 0 auto" }}>
          <BillyGreeting message="Hola, Dragón. Aquí es donde tienes que registrarte con tu correo de Mondragón" />
        </div>
      </div>
