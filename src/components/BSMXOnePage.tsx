...
// BIZENnePage.tsx — Landing one-page (React puro, sin Framer)
"use client"
          ...
          <div className="container hero-inner">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <a className="btn primary large" href={heroPrimaryUrl}>
                  {heroPrimaryLabel}
                </a>
              ...
              <ul className="badges" aria-label="Ventajas">
                <li>
                  <a href="/modules/menu">🎓 Microcredenciales</a>
                </li>
...
.hero-media img{object-fit:cover; width:100%; aspect-ratio: 16/10}
