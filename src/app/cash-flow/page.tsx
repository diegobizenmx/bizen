  ...
  return (
    <>
      <style>{`
        ...
        /* Tablet/iPad (768px-1160px) - respect fixed left sidebar (220px text-only) */
        ...
        /* Desktop (1161px+) - keep content in usable space (exclude fixed left sidebar, full width 280px) */
