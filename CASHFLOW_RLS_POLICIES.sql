...
-- =====================================================
-- Fixed: Removed ::text casting to prevent UUID type errors
...
DO $$
BEGIN
  RAISE NOTICE '✅ Cash Flow RLS policies updated successfully!';
  RAISE NOTICE '✅ Users can now create and manage their own games.';
  RAISE NOTICE '✅ UUID comparison fixed (no ::text casting)';
